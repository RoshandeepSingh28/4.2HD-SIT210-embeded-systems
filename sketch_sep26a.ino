...
#define FIREBASE_HOST "hdsit210roshan2310994804-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "AIzaSyA41QXmnL4nU1QOCSSJdwvDj97wVEgHtMA"

const char* ssid = "oplus_co_apdmkd";
const char* pass = "tohm3279";

FirebaseData fbData;
String fbPath = "/light/status"; // Path for the traffic light state
